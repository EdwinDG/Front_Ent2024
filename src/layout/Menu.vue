<template>
    <q-layout view="hHh LpR fFf" class="body">
        <q-header elevated class="custom-header">
            <q-toolbar
                class="bg-positive"
                style="background: #2e7d32 !important"
            >
        ...
        >
            <q-scroll-area style="height: calc(100% - 150px); margin-top: 85px">
                <q-list padding class="list">
                    ...
                    <router-link
                        v-if="checkAccess('TablaUsuarios')"
                        to="./TablaUsuarios"
                    >
                        <div class="div">
                            <q-item-section>
...
const checkAccess = (ruta) => {
    ...
    const rolesPermitidos = {
        ...
        Proceso: [ "admin", "bodega", "instructor"],
